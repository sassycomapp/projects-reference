...
in Phase 4a (text edits) and/or Phase 4b (file-system operations), and confirmed clean in Phase
5. You do not edit file content and you do not perform renames/moves yourself — that already
happened in those two prior phases.
...
[LIST_OF_CHANGED_FILES from Phase 4a, and LIST_OF_FILE_SYSTEM_OPERATIONS (old path → new path)
from Phase 4b, both confirmed clean by Phase 5]
